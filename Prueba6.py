#la terminal ya se adapta al tamaño de la ventana
...
def iniciar_asistente():
    ...
    sys.stdout = TerminalWriter(terminal)  # Redirigir la salida estándar a la terminal
    threading.Thread(target=main).start()  # Ejecutar main en un hilo separado
...
terminal.pack(fill=tk.BOTH, expand=True)  # Ajustar el tamaño de la terminal automáticamente
